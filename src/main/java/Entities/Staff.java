...
public class Staff extends  Person {
    ...
    public Staff(String name, Date dateOfBirth, Gender sex, String address, float salary, Date dateOfHiring, Post post) {
        super(name, dateOfBirth, sex, address);
        this.salary = salary;
        this.dateOfHiring = new GregorianCalendar();
    ...
    public Object[] toObject(){
        try {
            return new Object[]{getName(), getDateOfBirthString(), getAddress(), getSex(), getSalary(), getDateOfHiringString(), getPost()};
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return new Object[]{getName(), getDateOfBirthString(), getAddress(), getSex(), getSalary(), 0, getPost()};
    }
